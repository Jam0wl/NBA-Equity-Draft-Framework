...
# Ergänzung: Strikte Poolbindung der Equity

Equity darf im Playoff-Modul ausschließlich von Franchises angewendet werden,
die die Saison im Playoff-Pool beendet haben.

Beendet eine Franchise die Saison im Lottery-Pool, kann sie ihre Equity
nicht zur Verbesserung eines Playoff-Picks einsetzen – selbst dann nicht,
wenn sie durch Trades einen Playoff-Pick besitzt.

Diese Regel verhindert poolübergreifende Arbitrage und stellt sicher,
dass leistungsbasierte Vorteile nur innerhalb des eigenen Saison-Pools wirken.
